    ...
    <header className="bg-white dark:bg-gray-900 shadow-md">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-6 text-gray-800 dark:text-gray-200">
          ...
          <li><Link to="/users" className="hover:text-indigo-500">Users</Link></li>
        </ul>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 px-4 pb-4">
          <ul className="flex flex-col gap-3 text-gray-800 dark:text-gray-200">
            ...
            <li><a href="#" className="hover:text-indigo-500">Login</a></li>
            <li><a href="#" className="hover:text-indigo-500">Register</a></li>
            <li><a href="#" className="hover:text-indigo-500">Users</a></li>
          </ul>
        </div>
      )}
    </header>
